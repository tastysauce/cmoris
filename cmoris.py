...
cmoristxt = [ "Better start coding for android mike.",
 ...
 "I don't even have a clue how the fuck I could crack a screen besides a sledgehammer tbh",
 "Ill probably get an iPhone 6 As a burner. Maybe work phone or something",
 "I haven't realized it since 2006. Considering nothings changed besides the leather calendar, what makes you think ill change my mind now",
 "Normal iPhone user",
 ...
 "Worst ui ever",
 "I'd buy an iPhone if I could install windows phone on it. Cept I wouldnt because $845 is a RIDICULOUS price for that",
 "Wtf are you on crack? You can buy a surface pro 3 for less than that",
 "I'd buy a mac book and do the dual boot thing tho. That makes sense",
 ...
 "Irs a grid of buttons you can't customize",
